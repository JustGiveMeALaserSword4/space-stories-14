using Content.Shared._Stories.Examine.VerbScan; // Stories-HighPerishWarn
...
public partial class InventorySystem
{
    public void InitializeRelay()
    {
        ...
        SubscribeLocalEvent<InventoryComponent, RefreshEquipmentHudEvent<ShowPerishPercentComponent>>(RefRelayInventoryEvent); // Stories-HighPerishWarn
